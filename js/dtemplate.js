...
if(weburl.indexOf("https://mrlaboratory") != -1){
    ...
    tempdownf("https://www.google.com/search?q=site:mrlaboratory.info%20template"+templateSNumber);
...
if(!mrtemps==0){
   var templwor ="num4";
    ...
    // tempdownf("https://www.google.com/search?q=site:mrlaboratory.info%20template"+template);  
}
}else{
