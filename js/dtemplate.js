...
$(".downloadT a").css({"opacity":"100%","display": "block","padding": "5px","margin": "0px","text-decoration": "none","background": "#fff700","border-radius": "8px","color": "black","font-weight": "bold","position": "absolute","bottom": "50px","animation":"tempanimamr 5s infinite","cursor": "pointer","left":"3px"});
$(".downloadT img").css({"height": "100px","width": "85px","position": "absolute","right": "0px"});
